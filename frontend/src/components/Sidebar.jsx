   ...
   <div className="sidebar">
    <nav>
      <ul className="directories">
        <li><a href="/dashboard"><i class="bi bi-pip"></i><span>Dashboard</span></a></li>
        ...
        <li><a href="/suppliers"><i class="bi bi-building"></i><span>Suppliers</span></a></li>
        <li><a href="/sustainability"><i class="bi bi-globe"></i><span>Sustainability</span></a></li>
        <li><a href="/integrations"><i class="bi bi-columns-gap"></i><span>Integrations</span></a></li>
